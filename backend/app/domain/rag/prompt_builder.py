...
# backend/profiles/ 기준 절대 경로 (domain/rag/ → app/ → backend/)
...
_DEFAULT_PROFILE: dict = {
    ...
    "system_prompt_template": (
        ...
        "반드시 한국어로 답변하며, 제공된 문서만을 근거로 답변합니다. "
        "문서에 없는 내용은 '문서에서 확인되지 않음'이라고 명시합니다. "
        "각 주요 사실 뒤에 [출처: 파일명]을 표기합니다. "
        "문서에 명시된 용어를 그대로 사용하며, 임의로 동의어·번역·해석을 추가하지 않습니다.\n\n"
        "{context}"
    ),
    "few_shots": [],
    "deny_conditions": [],
